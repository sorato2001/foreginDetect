...
def _sam_tracking_evidence_metadata(sam_tracking_result: SAMTrackingResult, artifact: str) -> dict[str, Any]:
    ...
    return {
        ...
        "rule_region": {
            ...
            "continuous_band_polygons": [],
            "continuous_band_polygon_count": 0,
            "continuous_band_area": geometry.get("continuous_mask_area"),
            "rule_region_polygons": geometry.get("polygons", []),
            "rule_region_area": geometry.get("rule_region_area", geometry.get("raw_mask_area")),
        },
